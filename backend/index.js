...
// 3. 🎬 影音引擎 API
app.post('/api/generate-manga-video', videoController.generateMangaVideo);
app.post('/api/generate-interpolation-video', videoController.generateInterpolationVideo);
...
// 7. ⏰ 自動排程專屬通道 (GCP Cloud Scheduler 專用)
app.post('/api/cron/trigger', cronController.triggerCronJob); 

// ==========================================
// 8. 企業級 AI 代理人核心路由 (Agentic Workflow)
// ==========================================
